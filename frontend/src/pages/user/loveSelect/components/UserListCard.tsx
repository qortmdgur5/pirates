...
import check_img from "../../../../assets/image/check.png";
import uncheck_img from "../../../../assets/image/uncheck.png";
    ...
    <div className={styles.container}>
      <div className={styles.img_box}>
        <div className={styles.img_info}>
          <img src={gender ? man_icon : woman_icon} alt="user_img_png" />
        </div>
      </div>
      ...
      <button
        ...
        disabled={confirm}
      >
        <img src={isChecked ? check_img : uncheck_img} alt="check_img" />
      </button>
